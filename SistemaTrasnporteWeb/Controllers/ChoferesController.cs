...
namespace SistemaTrasnporteWeb.Controllers
{
    public class ChoferesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Cedula,Licencia,FechaNacimiento")] Chofer chofer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Cedula,Licencia,FechaNacimiento")] Chofer chofer)
        {
            if (id != chofer.Id)
            {
                return NotFound();
